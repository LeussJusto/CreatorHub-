...
const { connectAccount, listAccounts, oauthYoutubeStart, oauthYoutubeCallback, oauthTwitchStart, oauthTwitchCallback, oauthInstagramStart, oauthInstagramCallback, diagnoseIntegration } = require('../controllers/integrations.controller');
...
router.post('/connect', [
  body('platform').isIn(['twitch', 'youtube', 'instagram']),
